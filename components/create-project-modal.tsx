...
import { X, Rocket, Target, Calendar, Users } from 'lucide-react';
...
export default function CreateProjectModal({ onClose, onSuccess, currentUser }: CreateProjectModalProps) {
  const [formData, setFormData] = useState({
    name: '',
    description: '',
    pointA: '',
    pointB: '',
    openToTeamMembers: false,
  });
      ...
      >
        ...
        >
          ...
          <div className="forward-gradient text-white p-6 rounded-t-2xl">
            ...
            <p className="text-lg opacity-90 mt-2">Start your 2-week sprint journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Where are you now? What have you already accomplished?"
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Where do you want to be in 2 weeks? What will you have achieved?"
                  className="mt-2 min-h-[120px]"
                  required
                />
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-blue-900">2-Week Sprint Timeline</h4>
                  <p className="text-sm text-blue-700 mt-1">
                    Your project will run for 14 days with daily progress tracking. 
                    You'll be able to share updates, get feedback from experts, and 
